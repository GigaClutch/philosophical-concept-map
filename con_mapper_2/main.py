...
# Import simple visualization module
try:
    from simple_visualization import create_visualization as simple_create_visualization
    print("Using simple visualization module")
    # Monkey patch the visualization function if needed
    import sys
    if 'concept_map' in sys.modules:
        sys.modules['concept_map'].create_visualization = simple_create_visualization
    elif 'concept_map_integration' in sys.modules:
        sys.modules['concept_map_integration'].create_visualization = simple_create_visualization
except ImportError as e:
    print(f"Simple visualization module not available: {e}")
